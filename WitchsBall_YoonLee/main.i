...
extern BULLET generalBullets[70];
...
void goToStart() {
    ...
    DMANow(3, startscnPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, startscnTiles, &((charblock *)0x6000000)[0], 256 / 2);
    DMANow(3, startscnMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void instructions() {
    ...
    DMANow(3, instrscnPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, instrscnTiles, &((charblock *)0x6000000)[0], 1408 / 2);
    DMANow(3, instrscnMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((28) << 8) | (0 << 7) | (0 << 14);
    DMANow(3, gamescnPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, gamescnTiles, &((charblock *)0x6000000)[0], 288 / 2);
    DMANow(3, gamescnMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void pause() {
    ...
    DMANow(3, pausescnPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, pausescnTiles, &((charblock *)0x6000000)[0], 192 / 2);
    DMANow(3, pausescnMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void win() {
    ...
    DMANow(3, winscnPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, winscnTiles, &((charblock *)0x6000000)[0], 288 / 2);
    DMANow(3, winscnMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((28) << 8) | (0 << 7) | (0 << 14);
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8);
...
void lose() {
    ...
    DMANow(3, losescnPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, losescnTiles, &((charblock *)0x6000000)[0], 224 / 2);
    DMANow(3, losescnMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    (*(volatile unsigned short *)0x4000008) = ((0) << 2) | ((28) << 8) | (0 << 7) | (0 << 14);
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 8);
